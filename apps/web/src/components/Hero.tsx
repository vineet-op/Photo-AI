...
import { ChevronDown, Camera, Sparkles, Upload } from 'lucide-react';
import HeroImageGrid from './HeroImageGrid';
import { Badge } from "@/components/ui/badge";

const Hero = () => (
    <section className="max-h-screen overflow-hidden relative hero-gradient px-6 md:px-12 lg:px-24">
        ...
        <div className="max-w-7xl mx-auto pt-9 md:pt-32 md:pb-24 flex flex-col lg:flex-row items-center">
            ...
            <div className="w-full lg:w-1/2 lg:pr-12 space-y-6 mb-16 lg:mb-0 z-10  ">
                ...
                <div className="flex flex-wrap gap-4 pt-4 animate-fade-in [animation-delay:800ms]">
                    <Button size="lg" className="rounded-full px-8 py-6 text-base font-medium transition-all duration-300 hover:scale-105">
                        <Sparkles className="mr-2 h-5 w-5" />
                        Start Creating
                    </Button>
                    <Button size="lg" variant="outline" className="rounded-full px-8 py-6 text-base font-medium transition-all duration-300 hover:scale-105 border-2">
